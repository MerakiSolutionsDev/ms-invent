...
<head>
    ...
    <title>Inventarios y Kardex</title>
    <style media="screen">
        .meraki-search {
...
<body ng-app="ZSApp">
    ...
    <div class="meraki-font-s6 w3-sidebar w3-bar-block w3-card-2 w3-animate-left w3-hide-small" id="sidebarMenu" style="display:none;">
        ...
        <a title="Aquí puede crear nuevas zonas o sucursales" href="" class="w3-bar-item w3-button w3-border-bottom meraki-nav-class" onclick="w3.hide('.cardexBlock'); w3.show('#zonas-sucursales'); w3_close(); activeLink(event, 'meraki-nav-class')"><i class="fa fa-map-marker fa-fw" aria-hidden="true" style="width:25px"></i> Almacenes</a>
        ...
        <a title="Aquí puede consultas sobre los movimientos de sus productos" href="" class="w3-bar-item w3-button w3-border-bottom meraki-nav-class" onclick="w3.hide('.cardexBlock'); w3.show('#consultas'); w3_close(); activeLink(event, 'meraki-nav-class')"><i class="fa fa-flag fa-fw" aria-hidden="true" style="width:25px"></i> Kardex</a>
            ...
            $scope.showFactor = function(myE, prodID) {
                ...
                if (prodID !== $scope.workProdIndex) {
                    ...
                    if ($scope.temp_stock.length === 0) {
                        ...
                        if (!already) {
                            //alert('item added'+ ' ' + $scope.temp_stock+ ' ' + $scope.workProdIndex);
                            $scope.temp_stock.push({"index":$scope.workProdIndex,"stock":0});
                            $scope.workProdIndex = $scope.temp_stock.length;
                        }
                    }

                }
                //alert('workProdIndex'+ ' ' + $scope.workProdIndex);
